...
function Home() {
  return (
    <main className="flex flex-col gap-5 items-center justify-center text-lg p-3 w-80 min-w-52 mx-auto">
      ...
      <Link className="hover:text-blue-400 hover:bg-white/10 w-full border border-muted py-2 px-10 block rounded-lg text-center transition-colors" href='/dotaStats'>Dota2 Stats</Link>
